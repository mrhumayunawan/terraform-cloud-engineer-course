...
/* Sample Error
Professor-MacBook:v7-terraform-manifests-lifecycle-prevent_destroy kdaida$ terraform apply -auto-approve
...
╵
Professor-MacBook:v7-terraform-manifests-lifecycle-prevent_destroy kdaida$ 
*/
